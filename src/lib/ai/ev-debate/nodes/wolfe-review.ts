...
export async function wolfeReviewNode(
  ...
  const systemPrompt = `${persona.systemPromptAddition} Keep your review to 2-3 sentences. Focus on speed tiers, offensive benchmarks, and creative adjustments.`;
...
What would you change and why? Be specific about benchmarks.`;
