...
export const PROVIDERS: ProviderOption[] = [
  {
    ...
    models: [
      ...
      { id: "gpt-4.1-mini", label: "GPT-4.1 mini", tier: "fast", supportsTools: true },
    ],
  },
  {
    id: "anthropic",
  ...
  },
  {
    ...
    models: [
      // Via OpenRouter you get a union — pick a representative set.
      { id: "openai/gpt-4o", label: "GPT-4o (via OpenRouter)", tier: "balanced", supportsTools: true },
      { id: "openai/gpt-4o-mini", label: "GPT-4o mini (via OpenRouter)", tier: "fast", supportsTools: true },
      { id: "anthropic/claude-sonnet-4.5", label: "Claude Sonnet 4.5 (via OpenRouter)", tier: "balanced", supportsTools: true },
      { id: "anthropic/claude-opus-4.5", label: "Claude Opus 4.5 (via OpenRouter)", tier: "premium", supportsTools: true },
